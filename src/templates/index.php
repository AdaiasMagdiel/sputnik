		...
		<div class="mt-14">
			...
			<form method="POST" action="/" class="flex gap-2">
				<label class="flex items-center w-full gap-2 border-2 border-purple-100 rounded-md p-2">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256"><path class="fill-stone-400/80" d="M137.54 186.36a8 8 0 0 1 0 11.31l-9.94 10a56 56 0 0 1-79.22-79.27l24.12-24.12a56 56 0 0 1 76.81-2.28a8 8 0 1 1-10.64 12a40 40 0 0 0-54.85 1.63L59.7 139.72a40 40 0 0 0 56.58 56.58l9.94-9.94a8 8 0 0 1 11.32 0m70.08-138a56.08 56.08 0 0 0-79.22 0l-9.94 9.95a8 8 0 0 0 11.32 11.31l9.94-9.94a40 40 0 0 1 56.58 56.58l-24.12 24.14a40 40 0 0 1-54.85 1.6a8 8 0 1 0-10.64 12a56 56 0 0 0 76.81-2.26l24.12-24.12a56.08 56.08 0 0 0 0-79.24Z"/></svg>
					<input required name="link" id="link" class="bg-transparent flex-1 placeholder:text-stone-400/80 outline-none" type="text" placeholder="Enter your link here...">
				</label>
			...
			<div class="flex gap-2 mt-4">
				...
				<button class="flex gap-2 items-center justify-center px-4 py-2 border-2 border-purple-100 rounded-md text-purple-300 active:scale-95 font-medium">
					<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 256 256"><path fill="currentColor" d="M216 32H88a8 8 0 0 0-8 8v40H40a8 8 0 0 0-8 8v128a8 8 0 0 0 8 8h128a8 8 0 0 0 8-8v-40h40a8 8 0 0 0 8-8V40a8 8 0 0 0-8-8m-56 176H48V96h112Zm48-48h-32V88a8 8 0 0 0-8-8H96V48h112Z"/></svg>
					Copy Link
				</button>
			</div>
		</div>
